...
import { registerEmpresa } from '../../actions/auth';
import PropTypes from 'prop-types';

const RegisterCardEmpresa = ({registerEmpresa}) => {
    ...
    const {nombre, correo, telefono, password, password2, avatar, tipo, descripcion} = formData;
    ...
    const onSubmit = async e => {
        ...
        if(password !== password2){
            ...
            registerEmpresa({nombre, correo, telefono, password, avatar, tipo, descripcion});
        }
    }
...
RegisterCardEmpresa.propTypes = {
    registerEmpresa: PropTypes.func.isRequired
}


export default connect(mapStateToProps, {registerEmpresa})(RegisterCardEmpresa);